...
def seed_users():
    ...
    db.session.add_all((demo, alex, ali, andrei, ann, bill, brian, cory, hector, malcolm, mason, matt, min, nina, peang, peter, quinlan, rae, roderick, sophia, sophie, toney, zohaib, viviane, yoseph))
    db.session.commit()
